...
public class GalleryCursorManager {
    ...
    public static Cursor getAssetCursor(String requestedType, String albumName, ReactApplicationContext reactContext) {
        String[] projection = new String[] { MediaStore.Images.Media.DATE_ADDED, MediaStore.Images.Media.MIME_TYPE,
                MediaStore.Images.Media.DATA, MediaStore.Images.Media.DISPLAY_NAME, MediaStore.Video.Media.DURATION,
                MediaStore.Images.Media._ID, MediaStore.Images.Media.WIDTH, MediaStore.Images.Media.HEIGHT,
                MediaStore.Images.Media.TITLE, MediaStore.Files.FileColumns.MEDIA_TYPE,
